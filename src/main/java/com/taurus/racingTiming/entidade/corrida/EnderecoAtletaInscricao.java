 ...
 */
@Entity
@Table(name = "ENDERECO_ATLETA_INSCRICAO")
public class EnderecoAtletaInscricao extends BaseEntityID<Long> {
    ...
    public EnderecoAtletaInscricao() {
        super();
    }

    public EnderecoAtletaInscricao(Endereco endereco) {
        if (endereco != null) {
    ...
    public boolean equals(Object obj) {
        ...
        final EnderecoAtletaInscricao other = (EnderecoAtletaInscricao) obj;
